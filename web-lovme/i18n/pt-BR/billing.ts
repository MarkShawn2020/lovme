const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Refere-se ao número de chamadas de API que invocam apenas as capacidades de processamento da base de conhecimento do LovMe.',
    ...
    apiRateLimitTooltip: 'O limite da taxa da API se aplica a todas as solicitações feitas através da API LovMe, incluindo geração de texto, conversas de chat, execuções de fluxo de trabalho e processamento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Atualizações e Manutenção por LovMe Oficialmente',
        5: 'Acordos de Nível de Serviço negociados pelos Parceiros LovMe',
    ...
    community: {
      features: {
        ...
        2: 'Cumpre a Licença de Código Aberto LovMe',
      },
      name: 'Comunidade',
