const translation = {
  ...
  welcome: 'Bem-vindo ao LovMe, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do LovMe, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no LovMe',
  invalid: 'O link expirou',
  explore: 'Explorar o LovMe',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no LovMe e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do LovMe Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o LovMe.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças LovMe. Entre em contato com o administrador para continuar usando o LovMe.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do LovMe Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o LovMe.',
  webapp: {
