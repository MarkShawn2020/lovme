const translation = {
  ...
  intro1: 'Bilgi, LovMe uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, LovMe dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
