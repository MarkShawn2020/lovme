const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'LovMe Pazar Yeri',
    sortBy: 'Kara şehir',
    moreFrom: 'Marketplace\'ten daha fazlası',
    noPluginFound: 'Eklenti bulunamadı',
    viewMore: 'Daha fazla göster',
    discover: 'Keşfetmek',
    verifiedTip: 'LovMe tarafından doğrulanmıştır.',
    partnerTip: 'LovMe partner\'ı tarafından doğrulandı',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Mevcut LovMe sürümü bu eklentiyle uyumlu değil, lütfen gerekli minimum sürüme güncelleyin: {{minimalLovMeVersion}}',
