const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'LovMe\'nin sadece bilgi tabanı işleme yeteneklerini çağıran API çağrıları sayısını ifade eder.',
    ...
    apiRateLimitTooltip: 'LovMe API\'si aracılığıyla yapılan tüm isteklerde, metin oluşturma, sohbet konuşmaları, iş akışı yürütmeleri ve belge işleme dahil olmak üzere, API Oran Sınırı uygulanır.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'LovMe Tarafından Resmi Güncellemeler ve Bakım',
        5: 'LovMe Ortakları tarafından müzakere edilen SLA\'lar',
    ...
    community: {
      features: {
        ...
        2: 'LovMe Açık Kaynak Lisansına uyar',
      },
      price: 'Ücretsiz',
