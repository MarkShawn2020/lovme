const translation = {
  ...
  welcome: 'LovMe\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'LovMe Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'LovMe\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için LovMe Enterprise lisansının süresi doldu. LovMe\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'LovMe lisans sunucusuna bağlanılamadı. LovMe\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için LovMe Enterprise lisansı etkin değil. LovMe\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
