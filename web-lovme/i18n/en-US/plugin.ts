const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by LovMe',
    partnerTip: 'Verified by a LovMe partner',
  },
  task: {
  ...
  difyVersionNotCompatible: 'The current LovMe version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalLovMeVersion}}',
  auth: {
    default: 'Default',
    custom: 'Custom',
