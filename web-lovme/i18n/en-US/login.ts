const translation = {
  ...
  welcome: '👋 Welcome to LovMe, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting LovMe Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on LovMe',
  invalid: 'The link has expired',
  explore: 'Explore LovMe',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on LovMe and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The LovMe Enterprise license for your workspace has expired. Please contact your administrator to continue using LovMe.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect LovMe license server. Please contact your administrator to continue using LovMe.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The LovMe Enterprise license for your workspace is inactive. Please contact your administrator to continue using LovMe.',
  webapp: {
    login: 'Login',
