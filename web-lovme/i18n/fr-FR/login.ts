const translation = {
  ...
  welcome: 'Bienvenue sur LovMe, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer LovMe Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur LovMe',
  invalid: 'Le lien a expiré',
  explore: 'Explorez LovMe',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur LovMe et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence LovMe Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser LovMe.',
  licenseLostTip: 'Échec de la connexion au serveur de licences LovMe. Veuillez contacter votre administrateur pour continuer à utiliser LovMe.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence LovMe Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser LovMe.',
