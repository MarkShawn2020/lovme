const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'ตลาด LovMe',
    partnerTip: 'ได้รับการตรวจสอบโดยพันธมิตรของ LovMe',
    verifiedTip: 'ได้รับการตรวจสอบโดย LovMe',
  },
  task: {
  ...
  difyVersionNotCompatible: 'เวอร์ชั่นปัจจุบันของ LovMe ไม่สามารถใช้งานร่วมกับปลั๊กอินนี้ได้ กรุณาอัปเกรดไปยังเวอร์ชั่นขั้นต่ำที่ต้องการ: {{minimalLovMeVersion}}',
