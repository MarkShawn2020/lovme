const translation = {
  ...
  marketplace: {
    ...
    verifiedTip: 'Перевірено LovMe',
    partnerTip: 'Перевірено партнером LovMe',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Поточна версія LovMe не сумісна з цим плагіном, будь ласка, оновіть до мінімальної версії: {{minimalLovMeVersion}}',
