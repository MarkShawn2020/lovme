const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Відноситься до кількості викликів API, що викликають лише можливості обробки бази знань LovMe.',
    ...
    apiRateLimitTooltip: 'Обмеження частоти запитів застосовується до всіх запитів, зроблених через API LovMe, включаючи генерацію тексту, чат-розмови, виконання робочих процесів та обробку документів.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        5: 'Угоди про рівень обслуговування, узгоджені партнерами LovMe',
        ...
        7: 'Оновлення та обслуговування від LovMe Офіційно',
      },
    ...
    community: {
      features: {
        2: 'Відповідає ліцензії LovMe Open Source',
