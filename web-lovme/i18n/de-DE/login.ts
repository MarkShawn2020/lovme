const translation = {
  ...
  welcome: 'Willkommen bei LovMe, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit LovMe Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf LovMe beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'LovMe erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei LovMe angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des LovMe-Lizenzservers. Wenden Sie sich an Ihren Administrator, um LovMe weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die LovMe Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um LovMe weiterhin zu verwenden.',
  licenseExpiredTip: 'Die LovMe Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um LovMe weiterhin zu verwenden.',
