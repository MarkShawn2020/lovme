const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'LovMe-Konto',
    langGeniusAccountTip: 'Ihr LovMe-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei LovMe anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von LovMe ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in LovMes Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'LovMe {{version}} ist jetzt verfügbar.',
    latestAvailable: 'LovMe {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
