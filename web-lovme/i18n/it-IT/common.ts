const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account LovMe',
    langGeniusAccountTip: 'Il tuo account LovMe e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a LovMe per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da LovMe ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di LovMe.',
  ...
  about: {
    ...
    nowAvailable: 'LovMe {{version}} è ora disponibile.',
    latestAvailable: 'LovMe {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
