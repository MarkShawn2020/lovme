const translation = {
  ...
  marketplace: {
    ...
    verifiedTip: 'Verificato da LovMe',
    partnerTip: 'Verificato da un partner LovMe',
  },
  task: {
  ...
  difyVersionNotCompatible: 'L\'attuale versione di LovMe non è compatibile con questo plugin, si prega di aggiornare alla versione minima richiesta: {{minimalLovMeVersion}}',
