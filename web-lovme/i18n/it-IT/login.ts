const translation = {
  ...
  welcome: 'Benvenuto su LovMe, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare LovMe Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su LovMe',
  invalid: 'Il link è scaduto',
  explore: 'Esplora LovMe',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su LovMe e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze LovMe. Contatta il tuo amministratore per continuare a utilizzare LovMe.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza LovMe Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare LovMe.',
  licenseInactiveTip: 'La licenza LovMe Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare LovMe.',
