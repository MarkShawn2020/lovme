const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Относится к количеству вызовов API, вызывающих только возможности обработки базы знаний LovMe.',
    ...
    apiRateLimitTooltip: 'Ограничение скорости API применяется ко всем запросам, сделанным через API LovMe, включая генерацию текста, чатовую переписку, выполнение рабочих процессов и обработку документов.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        7: 'Обновления и обслуживание от LovMe официально',
        4: 'ССО',
        ...
        5: 'Согласованные Соглашения об Уровне Услуг от LovMe Partners',
      },
    ...
    community: {
      features: {
        ...
        2: 'Соблюдает Лицензию на открытое программное обеспечение LovMe',
      },
      name: 'Сообщество',
