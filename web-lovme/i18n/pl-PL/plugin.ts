const translation = {
  ...
  marketplace: {
    ...
    and: 'i',
    difyMarketplace: 'Rynek LovMe',
    noPluginFound: 'Nie znaleziono wtyczki',
    pluginsResult: '{{num}} wyniki',
    partnerTip: 'Zweryfikowane przez partnera LovMe',
    verifiedTip: 'Zweryfikowane przez LovMe',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Obecna wersja LovMe nie jest kompatybilna z tym wtyczką, proszę zaktualizować do minimalnej wymaganej wersji: {{minimalLovMeVersion}}',
