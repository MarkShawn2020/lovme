const translation = {
  ...
  welcome: 'Witaj w LovMe, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej LovMe, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na LovMe',
  invalid: 'Link wygasł',
  explore: 'Odkryj LovMe',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w LovMe, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja LovMe Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z LovMe.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji LovMe. Skontaktuj się z administratorem, aby kontynuować korzystanie z LovMe.',
  licenseInactiveTip: 'Licencja LovMe Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z LovMe.',
  webapp: {
