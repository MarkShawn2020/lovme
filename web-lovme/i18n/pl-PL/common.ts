const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto LovMe',
    langGeniusAccountTip: 'Twoje konto LovMe i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do LovMe, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez LovMe pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach LovMe.',
  ...
  about: {
    ...
    nowAvailable: 'LovMe {{version}} jest teraz dostępny.',
    latestAvailable: 'LovMe {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
