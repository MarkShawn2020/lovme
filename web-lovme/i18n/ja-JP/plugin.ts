const translation = {
  ...
  marketplace: {
    ...
    discover: '探索',
    and: 'と',
    difyMarketplace: 'LovMe マーケットプレイス',
    ...
    viewMore: 'もっと見る',
    verifiedTip: 'このプラグインは LovMe によって認証されています',
    partnerTip: 'このプラグインは LovMe のパートナーによって認証されています',
  },
  task: {
  ...
  difyVersionNotCompatible: '現在の LovMe バージョンはこのプラグインと互換性がありません。最小バージョンは{{minimalLovMeVersion}}です。',
  metadata: {
    title: 'プラグイン',
  },
