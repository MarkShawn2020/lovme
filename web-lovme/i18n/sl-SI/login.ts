const translation = {
  ...
  welcome: 'Dobrodošli v LovMe, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z LovMe Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na LovMe',
  invalid: 'Povezava je potekla',
  explore: 'Razišči LovMe',
  ...
  licenseExpiredTip: 'Licenca za LovMe Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati LovMe, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na LovMe, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom LovMe ni uspela. Če želite še naprej uporabljati LovMe, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca LovMe Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati LovMe, se obrnite na skrbnika.',
  webapp: {
