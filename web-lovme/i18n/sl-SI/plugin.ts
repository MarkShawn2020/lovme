const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani LovMe',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja LovMe',
  ...
  difyVersionNotCompatible: 'Trenutna različica LovMe ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimalLovMeVersion}}',
