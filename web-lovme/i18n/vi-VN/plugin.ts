const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'Xem thêm',
    difyMarketplace: 'Thị trường LovMe',
    discover: 'Khám phá',
    ...
    and: 'và',
    verifiedTip: 'Được xác nhận bởi LovMe',
    partnerTip: 'Được xác nhận bởi một đối tác của LovMe',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Phiên bản LovMe hiện tại không tương thích với plugin này, vui lòng nâng cấp lên phiên bản tối thiểu cần thiết: {{minimalLovMeVersion}}',
