const translation = {
  ...
  welcome: 'Bine ai venit la LovMe, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe LovMe Community Edition, citește',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe LovMe și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe LovMe. Contactați administratorul pentru a continua să utilizați LovMe.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența LovMe Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați LovMe.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența LovMe Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați LovMe.',
  webapp: {
