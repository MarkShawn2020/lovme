const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'Piața LovMe',
    moreFrom: 'Mai multe din Marketplace',
    and: 'și',
    viewMore: 'Vezi mai mult',
    partnerTip: 'Verificat de un partener LovMe',
    verifiedTip: 'Verificat de LovMe',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Versiunea curentă LovMe nu este compatibilă cu acest plugin, vă rugăm să faceți upgrade la versiunea minimă necesară: {{minimalLovMeVersion}}',
