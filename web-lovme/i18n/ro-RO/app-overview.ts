const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a LovMe cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a LovMe.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome LovMe Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
