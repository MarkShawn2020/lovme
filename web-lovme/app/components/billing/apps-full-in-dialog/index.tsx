...
const AppsFull: FC<{ loc: string; className?: string; }> = ({
  ...
  const { userProfile, companyVersionInfo } = useAppContext()
      ...
      <div className='flex justify-between'>
        ...
        {plan.type !== Plan.sandbox && plan.type !== Plan.professional && (
          <Button variant='secondary-accent'>
            <a target='_blank' rel='noopener noreferrer' href={mailToSupport(userProfile.email, plan.type, companyVersionInfo.current_version)}>
