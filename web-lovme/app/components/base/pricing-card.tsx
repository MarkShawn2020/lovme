    ...
    <div className={cn(
      ...
      {discount && (
        <div className="absolute -right-2 -top-2">
          <span className="rounded-full bg-gradient-to-r from-amber-500/20 to-yellow-500/20 border border-amber-400/30 px-3 py-1 text-xs font-semibold text-amber-300">
            {discount}
          </span>
        </div>
      )}
