...
const EnvNav = () => {
  ...
  const showEnvTag = companyVersionInfo.current_env === 'TESTING' || companyVersionInfo.current_env === 'DEVELOPMENT'
  ...
  return (
    <div className={`
      ...
      ${headerEnvClassName[companyVersionInfo.current_env]}
    `}>
      {
        companyVersionInfo.current_env === 'TESTING' && (
          <>
      ...
      {
        companyVersionInfo.current_env === 'DEVELOPMENT' && (
          <>
