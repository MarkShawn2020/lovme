(()=>{let t="lovmeChatbotConfig",h="lovme-chatbot-bubble-button",m="lovme-chatbot-bubble-window",y=window[t],a=!1,l=`
    position: absolute;
    display: flex;
